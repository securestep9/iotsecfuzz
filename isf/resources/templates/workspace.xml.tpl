...
<project version="4">
  ...
  <component name="RunManager" selected="Python.Run">
    <configuration name="Remote debug" type="PyRemoteDebugConfigurationType" factoryName="Python Remote Debug">
      <module name="test_module" />
      <option name="PORT" value="41441" />
    ...
    <list>
      ...
      <item itemvalue="Python Remote Debug.Remote debug" />
    </list>
  </component>
</project>